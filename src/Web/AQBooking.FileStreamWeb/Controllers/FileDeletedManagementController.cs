...
{
    public class FileDeletedManagementController : Controller
    {
        #region Fields
        ...
        #region Ctor
        public FileDeletedManagementController(IFileManagementService fileManagementService,
        ...
        {
            var result = _fileManagementService.SearchFileDeleted(searchModel);
            ViewBag.Host = host;
            ...
            return PartialView("_FileDeletedSearchResult", result.Data);
        }
        #endregion
    }
}