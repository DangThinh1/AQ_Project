...
namespace AQS.BookingAdmin.Infrastructure.Helpers
{
    public class SEOHelper
    {
        ...
        protected static void InitializeSeoCharacterTable()
        {
        ...
        protected static string ToUnichar(string hexString)
        {
            var b = new byte[2];
        ...
        public static string GetFriendlyUrl(string title)
        {
            ...
            bool allowUnicodeCharsInUrls = true;
        ...
        public static string GetFullFriendlyUrl(string hostName,string friendlyUrl,long recordId)
        {
           return $"{hostName}{friendlyUrl}-{recordId}";
        }
