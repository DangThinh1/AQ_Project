...
namespace AQBooking.FileStreamAPI.Core.Infrastructure
{
    public class AQEngine : IEngine
    {
        #region Properties
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new AQException("Unknown dependency");
                        return service;
                    });
            ...
            throw new AQException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
