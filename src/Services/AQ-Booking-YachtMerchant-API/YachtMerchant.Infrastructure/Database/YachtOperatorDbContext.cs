...
namespace YachtMerchant.Infrastructure.Database
{
    public partial class YachtOperatorDbContext : DbContext
    {
        public YachtOperatorDbContext()
        {
        }

        public YachtOperatorDbContext(DbContextOptions<YachtOperatorDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<YachtTourPricings>(entity =>
            {
                ...
                entity.Property(e => e.CurrencyCode).HasColumnName("CurrencyCode").HasMaxLength(10);

                entity.Property(e => e.CultureCode).HasColumnName("CultureCode").HasMaxLength(10);
            });
