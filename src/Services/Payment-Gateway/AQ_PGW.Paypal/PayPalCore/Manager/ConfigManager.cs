...
namespace PayPal.Api
{
    ...
    public sealed class ConfigManager
    {
        ...
        private readonly Dictionary<string, string> configValues = new Dictionary<string, string>() {
            {BaseConstants.ClientId, "AXBzX3BK0EIKIf87NiLs0FF56f6CBINvplAEI-eGQA5UCzlpzpsu1GwG3Jbz_0UaMcGVn6QF9xifYafT"},
            {BaseConstants.ClientSecret, "EHX5uun_f-IokPZKeziZPr8bP_S7NScvdqpw13mXaaHJz2TSVlNhsY8TjHqM3PTSzeZnDjkjtc4SlvtR"}
        };
