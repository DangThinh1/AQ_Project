...
namespace AQBooking.Identity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "AQ Portal Identity Api", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("v1/swagger.json", "AQ Portal Identity Api v1");
            });
    ...
    public static class ServiceCollectionExtension
    {
        public static void AddDependencyInjection(this IServiceCollection services)
        {
            ...
            services.TryAddScoped<ISinginControlService, SinginControlService>();
            services.TryAddScoped<ISSOAuthenticationService, SSOAuthenticationService>();
        }
