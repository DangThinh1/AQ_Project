...
{
    public class AQOutputFormatter : TextOutputFormatter
    {
        ...
        public AQOutputFormatter(Dictionary<Type, object> templates)
           : this(templates, DefaultJsonSerializerSettings, DefaultEncoding)
        {

        }

        public AQOutputFormatter(Dictionary<Type, object> templates, JsonSerializerSettings settings)
            : this(templates, settings, DefaultEncoding)
        {
        }

        public AQOutputFormatter(Dictionary<Type, object> templates, Encoding encoding)
            : this(templates, DefaultJsonSerializerSettings, encoding)
        {
        }

        public AQOutputFormatter(Dictionary<Type, object> templates, JsonSerializerSettings settings, Encoding encoding)
        {
            _templates = templates;
            _jsonSerializerSettings = settings;
            SupportedEncodings.Add(encoding);
        }
        public AQOutputFormatter()
        {
            SupportedMediaTypes.Add(MediaTypeHeaderValue.Parse("application/aqres"));
